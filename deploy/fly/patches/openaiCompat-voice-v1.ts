 ...
 *
 * Access: loopback (local voice) OR a valid session Bearer with chat
 * capability (cloud-connected desktop voice brain).
 */
...
/** Loopback for local voice; session Bearer for cloud-connected desktops. */
function authorizeCompat(c: {
