...
CONFIG_S3_PATH=fathom-config/fathom-web-api/production
...
docker tag fathom-web-api:latest 410192009209.dkr.ecr.us-east-1.amazonaws.com/fathom-web-api:latest
docker push 410192009209.dkr.ecr.us-east-1.amazonaws.com/fathom-web-api:latest

log "RESTARTING ECS SERVICES..."
aws ecs update-service --force-new-deployment --cluster fathom-web --service fathom-web-api-prod 1> /dev/null
