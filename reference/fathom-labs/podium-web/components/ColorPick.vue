<template>
    <div>
     ...
     <input type="text" id="color-input" checked/>
      <div class="relative flex flex-col items-center justify-center mt-7 mb-4">
          <div class="w-[200px] h-[200px] rounded-lg"  >
            <canvas id="color-block" height="200" width="200" class="rounded-lg"></canvas>
          </div>
          <div class="w-[200px] mt-8">
            <input type="range" min="0" max="360"  class="color-slider color-slider--hue" id="slider-hue">

            <div class="w-[100px] mx-auto	mt-8">
              <span class="block text-base text-sm text-gray-700">{{ t('Hex Value') }}</span>
              <div class="mt-1">
                  <input id="color" v-model="colorCode" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-400 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="# FFFFFF" />
                </div>
              </div>
          </div>
      </div>
