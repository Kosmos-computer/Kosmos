<template>
  <div class="min-h-full relative"> 
    <div class="flex flex-col">
      <div v-if="mainStore.projectMedia.length > 0">
    ...
    <div v-show="mainStoreState.projectMediaLoading.value == true || mainStoreState.projectMediaLoading.value == null" class="absolute inset-0 flex flex-col items-center pt-14 pb-14 bg-white bg-opacity-80"> 
      <SvgLoadingMd />
    </div>
  </div>
</template>
