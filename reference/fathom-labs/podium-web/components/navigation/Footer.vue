...
const fileSelected = computed(() => {
  ...
  return mainStore.files.length > 0 && route.name === 'upload';
});
...
footer {
  ...
  &.padding-bottom {
    padding-bottom: 101px; //continue-bar height
  }
}
</style>
