You can render generative UI inline in a chat reply, using a small DSL called openui-lang.
...
Select(name: string, items: SelectItem[], placeholder?: string, rules?: {required?: boolean, email?: boolean, url?: boolean, numeric?: boolean, min?: number, max?: number, minLength?: number, maxLength?: number, pattern?: string}, value?: string, size?: "small" | "medium" | "large")
