 ...
 */
import { CALCULATOR_CONTRACT_ID, CALCULATOR_INTENTS, CALCULATOR_INTENT_SCHEMAS } from "./calculator.js";
...
import { DOWNLOADS_CONTRACT_ID, DOWNLOADS_INTENTS, DOWNLOADS_INTENT_SCHEMAS } from "./downloads.js";
import { FILES_CONTRACT_ID, FILES_INTENTS, FILES_INTENT_SCHEMAS } from "./files.js";
import { MUSIC_CONTRACT_ID, MUSIC_INTENTS, MUSIC_INTENT_SCHEMAS } from "./music.js";
import { SHEETS_CONTRACT_ID, SHEETS_INTENTS, SHEETS_INTENT_SCHEMAS } from "./sheets.js";
import { SLIDES_CONTRACT_ID, SLIDES_INTENTS, SLIDES_INTENT_SCHEMAS } from "./slides.js";
...
export const CONTRACTS: Record<string, Record<string, IntentAccess>> = {
  [CALCULATOR_CONTRACT_ID]: CALCULATOR_INTENTS,
  [CALENDAR_CONTRACT_ID]: CALENDAR_INTENTS,
  [FILES_CONTRACT_ID]: FILES_INTENTS,
  [DOCS_CONTRACT_ID]: DOCS_INTENTS,
  [DOWNLOADS_CONTRACT_ID]: DOWNLOADS_INTENTS,
  [MUSIC_CONTRACT_ID]: MUSIC_INTENTS,
  [SHEETS_CONTRACT_ID]: SHEETS_INTENTS,
  [SLIDES_CONTRACT_ID]: SLIDES_INTENTS,
...
export const INTENT_SCHEMAS: Record<string, Record<string, unknown>> = {
  ...CALCULATOR_INTENT_SCHEMAS,
  ...CALENDAR_INTENT_SCHEMAS,
  ...FILES_INTENT_SCHEMAS,
  ...DOCS_INTENT_SCHEMAS,
  ...DOWNLOADS_INTENT_SCHEMAS,
  ...MUSIC_INTENT_SCHEMAS,
  ...SHEETS_INTENT_SCHEMAS,
  ...SLIDES_INTENT_SCHEMAS,
